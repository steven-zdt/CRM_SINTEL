...
(function(w, d) {
    ...
    async function cargarCategorias(categoriaSeleccionada = null) {
        ...
        try {
            ...
            // ⚠️ El endpoint retorna formato paginado {count, results, next, previous}
            ...
            // Agregar categorías (solo ACTIVO o TODO)
    ...
    async function guardarActivo(e) {
        ...
        try {
            if (activoId) {
                ...
                res = await w.http('PATCH', `${CORE_API_BASE}/${activoId}/`, payload);
            } else {
