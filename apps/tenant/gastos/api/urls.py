...
WARNING: CRÍTICO: El router debe estar correctamente configurado para que DRF genere las rutas:
- GET /api/v1/gastos/ (list)
- POST /api/v1/gastos/ (create) - WARNING: v2.40: Usa automáticamente resolución vigente
...
- GET /api/v1/gastos/resolucion-activa/ (resolucion_activa action) - WARNING: DEPRECATED: Usar /api/v1/resoluciones-dian/activa/
- POST /api/v1/gastos/configurar-resolucion/ (configurar_resolucion action) - WARNING: DEPRECATED: Usar POST /api/v1/resoluciones-dian/
- POST /api/v1/gastos/{id}/anular/ (anular action)

WARNING: v2.40: Nuevo ViewSet independiente para Resoluciones DIAN:
...
# WARNING: RECONSTRUCCIÓN COMPLETA DEL ROUTER (v2.40)
# Router para esta app
router = DefaultRouter()

# WARNING: CRÍTICO: Registro en la raíz (string vacío) porque el prefijo 'gastos/' ya está en config/api_urls.py
...
# WARNING: CRÍTICO: No usar include(router.urls) dentro de otro include, usar router.urls directamente
