"""
Pytest fixtures for Empresa tests.
"""
import pytest
...
def tenant(db):
    """
    Simple fixture that returns an existing test tenant, con `empresa` y
    `perfil` migrados. Mismo patron que apps/tenant/proveedores/tests/conftest.py.
    """
    tenant_obj = (
