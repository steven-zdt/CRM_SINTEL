...
⚠️ CRÍTICO: Este archivo está en apps/tenant/empleados/services/__init__.py
...
# ⚠️ v2.95: Importar directamente desde el módulo services.py del paquete padre
...
try:
    ...
    # ⚠️ v2.60: LIST_FIELDS y DETAIL_FIELDS son diccionarios que contienen todas las constantes
    ...
    # ⚠️ v2.60: Funciones de cálculo de nómina colombiana
    ...
    # ⚠️ v2.40: Nuevas funciones de gestión de empleados
    ...
    # ⚠️ v2.95: Funciones de gestión de contratos y nómina
    ...
    # ⚠️ v2.60: Nómina Multitanda - Validación de límite de días
...
# ⚠️ v2.60: Exportar explícitamente todas las funciones y constantes requeridas
__all__ = [
