...
⚠️ v2.40: Arquitectura API-First con Tabulator Factory.
...
# ⚠️ CRÍTICO: Importar ViewSets directamente (sin try/except para ver errores reales)
from .viewsets import EmpleadoViewSet, ContratoViewSet, DevengoViewSet

# Router para esta app
router = DefaultRouter()

# ⚠️ CRÍTICO: Orden de registro es importante
...
# ⚠️ CRÍTICO: EmpleadoViewSet debe registrarse AL FINAL con r'' para que sea la ruta base
...
logger.info("✅ URLs de empleados configuradas correctamente")
if urlpatterns:
    ...
    logger.error("❌ ERROR CRÍTICO: El router de empleados no generó ninguna URL")