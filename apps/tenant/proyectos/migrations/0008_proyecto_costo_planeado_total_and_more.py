...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.DecimalField(decimal_places=2, default=0, help_text='Suma de ItemPresupuestoProyecto — Zero Waste caché', max_digits=15),
        ),
        migrations.AddField(
            model_name='proyecto',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.CharField(choices=[('MANO_OBRA', 'Mano de Obra'), ('EQUIPOS', 'Equipos'), ('MATERIALES', 'Materiales')], help_text='Mano de Obra, Equipos o Materiales', max_length=20, verbose_name='Categoría')),
                ('descripcion', models.CharField(blank=True, help_text='Ej: Instalación de cableado, Alquiler de grúa, etc.', max_length=300, verbose_name='Descripción')),
                ...
                ('subtotal', models.DecimalField(decimal_places=2, default=0, help_text='cantidad × valor_unitario (calculado en service layer)', max_digits=15, verbose_name='Subtotal')),
