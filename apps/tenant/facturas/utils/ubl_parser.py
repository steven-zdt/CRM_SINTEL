...
# WARNING: v2.30: Service Layer Pattern - Separado de services.py para mantener SRP.
Este módulo solo mapea UBL→DTO; el parsing de bytes se hace en xml_parser.

# WARNING: CONSUME: apps/services/xml_parser para helpers genéricos (xpath, text, attr).
# WARNING: NO PARSEA BYTES: Acepta root ya parseado (etree._Element).

# WARNING: SEGURIDAD: Parser robusto con namespaces dinámicos y local-name() para evitar
...
from apps.services.document_parser.xml_parser.core import xpath
