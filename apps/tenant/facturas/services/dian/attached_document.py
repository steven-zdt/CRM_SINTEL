"""
Contenedor AttachedDocument DIAN para transmision de la Factura Electronica.

Ref: Anexo Tecnico FE DIAN v1.9 seccion 6 (Envio documentos).

El AttachedDocument envuelve el Invoice XML firmado en CDATA dentro
...
class AttachedDocumentService:
    ...
    @classmethod
    def build(cls, signed_invoice_bytes: bytes, dto: dict, cufe: str) -> bytes:
        """
        Envuelve el Invoice XML firmado en un AttachedDocument DIAN.
