    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fecha_fin_vigencia",
                    models.DateField(blank=True, null=True, verbose_name="Fecha Fin de Vigencia"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "clase",
                    models.CharField(
                        choices=[("PN", "Persona Natural"), ("PJ", "Persona Jurídica")],
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["clase", "activo"], name="impuestos_c_clase_ada382_idx"),
                    models.Index(
                        fields=["segmento_dian", "activo"], name="impuestos_c_segment_c9f120_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["estado", "created_at"], name="impuestos_d_estado_0c41c3_idx"
                    ),
                    models.Index(fields=["hash_sha256"], name="impuestos_d_hash_sh_2bc943_idx"),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "nombre",
                    models.CharField(
                        help_text="Nombre del régimen", max_length=120, verbose_name="Nombre"
                    ),
                ),
                (
                    "descripcion",
            ...
            options={
                ...
                "ordering": ("codigo",),
                "indexes": [
                    models.Index(fields=["codigo", "activo"], name="impuestos_r_codigo_c285da_idx")
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "ordering": ("codigo",),
                "indexes": [
                    models.Index(fields=["codigo", "activo"], name="impuestos_r_codigo_f52d79_idx"),
                    models.Index(
                        fields=["es_responsable_iva", "activo"],
                        name="impuestos_r_es_resp_d24976_idx",
                    ),
                    models.Index(
                        fields=["es_facturador_electronico", "activo"],
                        name="impuestos_r_es_fact_c75cdb_idx",
                    ),
                ],
            },
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="impuestos.contribuyentetipo",
                        verbose_name="Tipo de Contribuyente",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ManyToManyField(
                        ...
                        related_name="perfiles",
                        to="impuestos.responsabilidadrut",
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["documento", "etapa", "ts"], name="impuestos_i_documen_cbcbca_idx"
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "texto_plano",
                    models.TextField(
                        help_text="Texto de la norma en formato plano", verbose_name="Texto Plano"
                    ),
                ),
                (
                    "referencias",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["articulo", "impuesto"], name="impuestos_n_articul_8b38d4_idx"
                    ),
                    models.Index(
                        fields=["vigencia_desde", "vigencia_hasta"],
                        name="impuestos_n_vigenci_88b173_idx",
                    ),
                    models.Index(
                        fields=["documento_fuente"], name="impuestos_n_documen_38fb50_idx"
                    ),
                ],
            },
        ),
        ...
        migrations.AddIndex(
            model_name="perfiltributario",
            index=models.Index(
                fields=["tipo_contribuyente", "activo"], name="impuestos_p_tipo_co_01076d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="perfiltributario",
            index=models.Index(
                fields=["regimen_renta", "activo"], name="impuestos_p_regimen_60d3e5_idx"
            ),
        ),
    ]
