...
crud_router.register(
    r"impuestos/tipos-crud", TipoImpuestoCRUDViewSet, basename="tipo-impuesto-crud"
)
crud_router.register(
    r"impuestos/tarifas-iva-crud", TarifaIVACRUDViewSet, basename="tarifa-iva-crud"
)
crud_router.register(
    r"impuestos/conceptos-retencion-crud",
    ConceptoRetencionCRUDViewSet,
    basename="concepto-retencion-crud",
)
crud_router.register(
    r"impuestos/codigos-tributarios-crud",
    CodigoTributarioCRUDViewSet,
    basename="codigo-tributario-crud",
)
crud_router.register(
    r"impuestos/actividades-economicas-crud",
    ActividadEconomicaCRUDViewSet,
    basename="actividad-economica-crud",
)
crud_router.register(
    r"impuestos/normas-crud", NormaTributariaCRUDViewSet, basename="norma-tributaria-crud"
)
...
urlpatterns = [
    ...
    path(
        "impuestos/dt/conceptos-retencion/",
        ConceptoRetencionDataTablesView.as_view(),
        name="dt-conceptos-retencion",
    ),
    path(
        "impuestos/dt/codigos-tributarios/",
        CodigoTributarioDataTablesView.as_view(),
        name="dt-codigos-tributarios",
    ),
    path(
        "impuestos/dt/actividades-economicas/",
        ActividadEconomicaDataTablesView.as_view(),
        name="dt-actividades-economicas",
    ),
]
