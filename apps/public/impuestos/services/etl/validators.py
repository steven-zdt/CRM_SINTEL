...
def _validate_tarifa_iva(tarifa: Dict) -> List[str]:
    ...
    if vigencia_desde and vigencia_hasta and vigencia_hasta < vigencia_desde:
        errors.append(f"Fecha fin de vigencia anterior a fecha inicio: {vigencia_hasta} < {vigencia_desde}")
...
def _dates_overlap(start1: date | None, end1: date | None, start2: date | None, end2: date | None) -> bool:
