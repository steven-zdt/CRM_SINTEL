...
class IngestaCreateView(LoginRequiredMixin, StaffRequired, TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        headers = {
            ...
            "Authorization": f"Token {request.session.get('auth_token', '')}" if request.session.get('auth_token') else None,
        }
...
def htmx_logs_fragment(request, pk):
    ...
    return render(request, "console/pages/impuestos/fragments/logs.html", {"doc": doc, "logs": logs})
