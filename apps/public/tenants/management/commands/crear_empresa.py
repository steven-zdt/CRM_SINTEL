...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # WARNING: v2.17: Informar sobre subdominio automático
        ...
        try:
            # WARNING: v2.17: Usar el servicio de onboarding sin parámetro dominio
            ...
            self.stdout.write(self.style.SUCCESS("\nOK: Empresa creada exitosamente!"))
            self.stdout.write("\n📋 Resumen:")
            ...
            if user:
                ...
                self.stdout.write(
                    self.style.WARNING("   - Usuario admin: No creado (ya existe o error)")
                )
