...
⚠️ v2.30: Comando operativo para garantizar migraciones de tenants.
...
class Command(BaseCommand):
    help = "Aplica migraciones (TENANT_APPS) a un tenant específico o a todos, de forma idempotente."
    ...
    def handle(self, *args, **options):
        ...
        if all_tenants:
            ...
            try:
                ...
                self.stdout.write(self.style.SUCCESS("✅ Migraciones aplicadas a todos los tenants."))
            ...
            try:
                ...
                if not client:
                    raise CommandError(
                        f"❌ No se encontró un tenant con schema '{schema}'. "
                ...
                self.stdout.write(self.style.SUCCESS(f"✅ Migraciones aplicadas al tenant '{schema}'."))
