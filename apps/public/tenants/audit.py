...
class TenantAuditLogger:
    ...
    def log_event(self, action: str, message: str, user=None, level=logging.INFO, extra_data=None):
        """
    ...
    def log_logout(self, user, **kwargs):
        ...
        self.log_event(
            action="LOGOUT", message=f"User logout: {user}", user=user, extra_data=kwargs
        )
