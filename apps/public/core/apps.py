...
WARNING: SERVER GUARD: Este AppConfig contiene lógica de validación que se ejecuta
...
class CoreConfig(AppConfig):
    ...
    WARNING: SERVER GUARD: Contiene validaciones que se ejecutan al arrancar.
    ...
    label = (
        "public_core"  # WARNING: CRÍTICO: Label único para evitar conflicto con apps.tenant.core
    )
    ...
    def ready(self):
        ...
        WARNING: CRÍTICO: NO ejecutar validaciones durante comandos de mantenimiento.
        - makemigrations: No hay tablas aún, fallaría
        - migrate/migrate_schemas: Están creando las tablas
        - collectstatic: No necesita BD

        WARNING: REGLA DE ORO: Solo ejecutar validaciones cuando el servidor está corriendo.
        """
        # WARNING: GUARDA CRÍTICA: Omitir validaciones durante comandos de mantenimiento
