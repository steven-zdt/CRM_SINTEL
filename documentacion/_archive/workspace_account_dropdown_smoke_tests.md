...
**Verificaciones:**
- [ ] Abrir `http://cliente.sintel.net.co:8000/workspace/` (autenticado)
...
**Verificaciones:**
- [ ] Abrir `http://cliente.sintel.net.co:8000/workspace/`
...
- [ ] Verificar que:
  - [ ] La URL cambia a `http://cliente.sintel.net.co:8000/workspace/#perfil`
...
**Verificaciones:**
- [ ] Navegar directamente a `http://cliente.sintel.net.co:8000/workspace/#perfil`
- [ ] Verificar que se carga la sección de Perfil
- [ ] Navegar a `http://cliente.sintel.net.co:8000/workspace/#empresa`
