...
MIDDLEWARE = [
    ...
    'apps.public.core.middleware.RequestContextMiddleware',  # [OK] LOGGING: Añade request_id y schema_name a los logs (después de TenantMainMiddleware para tener request.tenant)
...
# Feature Flags
# ============================================================================
# [WARNING] ROLLOUT GRADUAL: Feature flags para habilitar funcionalidades de forma controlada
...
# [WARNING] v2.35: Pipeline XML Canónico (SSoT)
...
# [WARNING] v2.36: Document Ingest Pipeline Universal (FASE 0)
...
# [WARNING] OBSERVABILIDAD: request_id es opcional (solo si RequestContextMiddleware está activo)
...
LOGGING = {
    ...
    "formatters": {
        # [WARNING] DESARROLLO: Formatter simple sin request_id (no rompe en arranque/import-time)
        "simple": {
        ...
        # [WARNING] OPCIONAL: Formatter con contexto (solo si RequestContextMiddleware está activo)
        ...
        # [WARNING] FASE 5: Formatter JSON estructurado para observabilidad (opcional)
        "json": {
            "format": (
    ...
    "handlers": {
        "console": {
            ...
            # [WARNING] DESARROLLO: Usar formatter simple (sin request_id) por defecto
    ...
    "loggers": {
        # [WARNING] FASE 5: Canal principal del pipeline de importación (Service Layer)
        "tenant.facturas.import": {
            "handlers": ["console"],
            "level": "INFO",
            "propagate": False,
        },
        # [WARNING] FASE 5: Regla de naturaleza (comparación emisor vs Empresa)
        "tenant.facturas.naturaleza": {
            "handlers": ["console"],
            "level": "INFO",
            "propagate": False,
        },
        # [WARNING] FASE 5: Borrado/rollback
        "tenant.facturas.delete": {
            "handlers": ["console"],
            "level": "INFO",
            "propagate": False,
        },
        # [WARNING] Pipeline universal: Tarea Celery de ingesta de documentos
        "services.document_ingest.task": {
            "handlers": ["console"],
            "level": "INFO",
            "propagate": False,
        },
        # [WARNING] Pipeline universal: Router/parsers de documentos
        "services.document_ingest.parse": {
            "handlers": ["console"],
            "level": "INFO",
            "propagate": False,
        },
        # [WARNING] FASE 5: Healthchecks
        "core.health": {
            "handlers": ["console"],
            "level": "INFO",
            "propagate": False,
        ...
        # [WARNING] DESARROLLO: Server logs a WARNING (reducir ruido en dev)
        "django.server": {
            "handlers": ["console"],
            "level": "WARNING" if DEBUG else "INFO",
            "propagate": False,
        },
        # [WARNING] NORMALIZACIÓN: Logger principal de facturas (upload, import, etc.)
        "facturas": {
            "handlers": ["console"],
            "level": "INFO",
            "propagate": False,
        ...
        # [WARNING] NORMALIZACIÓN: Logger principal de document_ingest
        "apps.services.document_ingest": {
            "handlers": ["console"],
            "level": "INFO",
            "propagate": False,
        },
        # [WARNING] NORMALIZACIÓN: Logger de Celery
        "mailinbox.api": {
            "handlers": ["console"],
            "level": "INFO",
            "propagate": False,
...
# [WARNING] PRODUCCIÓN: Handler de archivo condicional (solo si DEBUG=False y ruta válida)
