...
⚠️ OBJETIVO: Garantizar que un token de activación solo se puede usar una vez.
"""
import pytest
...
class TestActivacionUnaSolaVez:
    ...
    def test_activacion_muestra_formulario_si_password_usable(self, django_user_model):
        """
        ⚠️ v2.29: Verifica que la activación MUESTRA el formulario incluso si el usuario ya tiene password usable.
