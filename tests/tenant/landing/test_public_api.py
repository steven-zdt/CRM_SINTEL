...
class TestLandingPublicAPI(SintelTenantTestCase):
    ...
    def setUp(self):
        ...
        # [WARNING] IMPORTANTE: El NIT debe estar sin puntos (el servicio lo limpia, pero mejor pasarlo limpio)
        self.empresa = crear_o_actualizar_empresa(
            razon_social="Sintel Corp",  # [OK] Público
            nit="900000000",  # [WARNING] SENSIBLE: No debe aparecer (sin puntos para evitar errores de validación)
            direccion="Dirección Privada",  # [WARNING] PRIVADO: No debe aparecer
            telefono="6012345678",  # [WARNING] PRIVADO: No debe aparecer
            email_contacto="contacto@sintel.net.co",  # [OK] Público
            regimen_tributario="Gran Contribuyente",  # [WARNING] SENSIBLE: No debe aparecer
            website="https://sintel.net.co",  # [OK] Público
        )
    ...
    def test_serializer_whitelist(self):
        ...
        # [WARNING] IMPORTANTE: Configurar HTTP_HOST para que el middleware de routing funcione
        ...
        # [OK] Validar que campos PÚBLICOS están presentes
        self.assertIn(
            "razon_social",
            data,
        ...
        self.assertIn(
            "website", data, "El campo 'website' debe estar presente (público)"
        )

        # [WARNING] Validar que campos SENSIBLES NO están presentes
        self.assertNotIn(
            "nit", data, "El campo 'nit' NO debe estar presente (dato sensible/fiscal)"
        )
        self.assertNotIn(
            "dv", data, "El campo 'dv' NO debe estar presente (dato sensible/fiscal)"
        )
        self.assertNotIn(
            "regimen_tributario",
            data,
        ...
        self.assertNotIn(
            "id", data, "El campo 'id' NO debe estar presente (dato interno)"
        )
        self.assertNotIn(
            "direccion",
            data,
