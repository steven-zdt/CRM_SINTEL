...
⚠️ POLÍTICA API-First: El logout retorna JSON con redirect_url="/",
...
class TenantLogoutAPISmokeTestCase(SintelTenantTestCase):
    ...
    def setUp(self):
        ...
        self.client.defaults['HTTP_HOST'] = 'test-tenant.sintel.com'
    ...
    def test_logout_post_authenticated(self):
        ...
        # Llamar al endpoint de logout
        url = reverse('tenant_landing_api:logout')
        response = self.client.post(url, HTTP_HOST='test-tenant.sintel.com')
