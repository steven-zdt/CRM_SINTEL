...
class TestLandingAPI:
    ...
    def test_api_info_returns_tenant_data(self):
        ...
        with schema_context(get_public_schema_name()):
            ...
            tenant = Client.objects.create(
                schema_name="test_tenant", nombre="Test Empresa", is_active=True
            )

            # Crear dominio para el tenant
            domain = Domain.objects.create(
                tenant=tenant, domain="test-tenant.com", is_primary=True
            )
        ...
        assert (
            "/dashboard/" in data["dashboard_url"]
    ...
    def test_api_info_is_public(self):
        ...
        with schema_context(get_public_schema_name()):
            tenant = Client.objects.create(
                schema_name="test_public", nombre="Test Public", is_active=True
            )
            Domain.objects.create(
                tenant=tenant, domain="test-public.com", is_primary=True
            )
...
class TestLandingHTML:
    ...
    def test_landing_page_returns_200_ok(self):
        ...
        with schema_context(get_public_schema_name()):
            tenant = Client.objects.create(
                schema_name="test_html", nombre="Test HTML Empresa", is_active=True
            )
            Domain.objects.create(
                tenant=tenant, domain="test-html.com", is_primary=True
            )
        ...
        assert (
            "Test HTML Empresa" in content or "test_html" in content
    ...
    def test_landing_page_shows_login_button_for_anonymous(self):
        ...
        with schema_context(get_public_schema_name()):
            tenant = Client.objects.create(
                schema_name="test_anonymous", nombre="Test Anonymous", is_active=True
            )
            Domain.objects.create(
                tenant=tenant, domain="test-anonymous.com", is_primary=True
            )
        ...
        assert (
            "Iniciar Sesión" in content
        ), "Debe mostrar el botón 'Iniciar Sesión' para usuarios anónimos"
        assert (
            "/admin/login/" in content or "admin:login" in content
    ...
    def test_landing_page_shows_dashboard_button_for_authenticated(self):
        ...
        with schema_context(get_public_schema_name()):
            ...
            Domain.objects.create(
                tenant=tenant, domain="test-authenticated.com", is_primary=True
            )
        ...
        assert (
            "Ir a mi Dashboard" in content or "Dashboard" in content
        ), "Debe mostrar el botón 'Ir a mi Dashboard' para usuarios autenticados"
        assert "/dashboard/" in content, "Debe contener el link al dashboard"
...
class TestLandingArchitecture:
    ...
    def test_api_and_html_use_same_tenant_data(self):
        ...
        with schema_context(get_public_schema_name()):
            ...
            Domain.objects.create(
                tenant=tenant, domain="test-consistency.com", is_primary=True
            )
        ...
        assert (
            api_data["nombre"] in html_content or tenant.schema_name in html_content
    ...
    def test_api_follows_sintel_api_first_standard(self):
        ...
        with schema_context(get_public_schema_name()):
            tenant = Client.objects.create(
                schema_name="test_standard", nombre="Test Standard", is_active=True
            )
            Domain.objects.create(
                tenant=tenant, domain="test-standard.com", is_primary=True
            )
