...
class TestDashboardShellAPIFirst(TestCase):
    ...
    def test_shell_uses_module_script(self):
        ...
        self.assertIn(
            "/static/tenant/dashboard/js/dashboard.js",
            content,
    ...
    def test_shell_no_direct_app_endpoints(self):
        ...
        for pattern in prohibited_patterns:
            ...
            if matches:
                self.fail(
                    f"Llamada directa a endpoint no Core encontrada: {matches[0]}"
                )
    ...
    def test_shell_no_inline_scripts(self):
        ...
        for script in inline_scripts:
            ...
            if len(script) > 200:
                self.fail(
                    f"Script inline grande encontrado (debe ser módulo ES): {script[:100]}..."
                )
