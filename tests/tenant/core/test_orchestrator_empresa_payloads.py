...
class TestOrchestratorEmpresaPayloads(SintelTenantTestCase):
    ...
    def setUp(self):
        ...
        self.empresa = Empresa.objects.create(
            razon_social="Empresa Test", nit="900123456", singleton_key=1
        )
        ...
        with schema_context(public_schema):
            ...
            TenantMembership.objects.create(
                client=tenant, user=self.admin_user, rol="ADMIN", is_active=True
            )
    ...
    def test_patch_response_content_type_is_json(self):
        ...
        payload = {"razon_social": "Empresa Test Content-Type"}
