...
⚠️ POLÍTICA: Verificar que los endpoints de auth centralizados funcionan correctamente.
"""
import pytest
...
class TestCoreAuthEndpoints(SintelTenantTestCase):
    ...
    def test_login_endpoint_accessible_anon(self):
        ...
        assert r.status_code in [200, 401, 403], f"Status code inesperado: {r.status_code}"
        data = r.json()
