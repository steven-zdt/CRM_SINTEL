...
⚠️ POLÍTICA: Verificar que los shells estáticos se cargan correctamente.
"""
import pytest
...
class TestCoreStaticShells(SintelTenantTestCase):
    ...
    def test_landing_index_shell_loads(self):
        ...
        if r.status_code in [301, 302]:
            ...
            assert 'static/tenant/core/landing/index.html' in location or '/static/tenant/core/landing/index.html' in location
    ...
    def test_reset_index_shell_loads(self):
        ...
        if r.status_code in [301, 302]:
            location = r.get('Location', '')
            assert 'static/tenant/core/landing/reset/index.html' in location or '/static/tenant/core/landing/reset/index.html' in location
