...
from apps.tenant.core.admin import tenant_admin_site, ensure_tenant_apps_registered
...
class TenantAdminSiteIsolationTests(TestCase):
    ...
    def test_tenant_models_are_registered(self):
        ...
        ✅ Debe pasar: Empresa, Factura, etc. deben estar registrados
        """
        ...
        for model in tenant_models:
            with self.subTest(model=model.__name__):
                self.assertTrue(
                    ...
                    f"❌ {model.__name__} NO está registrado en tenant_admin_site. "
    ...
    def test_public_models_are_not_registered(self):
        ...
        ✅ Debe pasar: Client, Domain, User (global) NO deben estar registrados
        """
        ...
        for model in public_models:
            with self.subTest(model=model.__name__):
                self.assertFalse(
                    tenant_admin_site.is_registered(model),
                    f"❌ VULNERABILIDAD: {model.__name__} está registrado en tenant_admin_site. "
    ...
    def test_tenant_admin_site_has_correct_configuration(self):
        ...
        ✅ Debe pasar: site_header, site_title, index_title deben estar configurados
        """
        self.assertEqual(
    ...
    def test_tenant_admin_site_permissions(self):
        ...
        ✅ Debe pasar: Solo usuarios activos y staff pueden acceder
        """
    ...
    def test_registered_models_list(self):
        ...
        ✅ Debe pasar: Solo modelos de TENANT_APPS deben estar en la lista
        """
        ...
        for public_model_name in public_model_names:
            self.assertNotIn(
                ...
                f"❌ VULNERABILIDAD: {public_model_name} está registrado en tenant_admin_site. "
        ...
        found_tenant_models = [name for name in tenant_model_names if name in registered_model_names]
    ...
    def test_ensure_tenant_apps_registered_is_idempotent(self):
        ...
        ✅ Debe pasar: Llamar la función múltiples veces no debe causar errores
        """
    ...
    def test_tenant_admin_site_is_independent(self):
        ...
        ✅ Debe pasar: Los registros en tenant_admin_site no afectan admin.site
        """
