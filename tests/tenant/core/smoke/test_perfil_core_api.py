...
⚠️ MULTI-TENANT: Estos tests verifican que los endpoints Core API están correctamente registrados
...
def test_core_perfil_endpoints_401_if_not_authenticated(client):
    ...
    ⚠️ SEGURIDAD: Los endpoints Core API requieren autenticación.
    """
