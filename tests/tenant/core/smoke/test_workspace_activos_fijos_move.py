...
class WorkspaceActivosFijosMoveSmokeTest(SimpleTestCase):
    ...
    def test_template_exists(self):
        ...
        self.assertTrue(
            TEMPLATE_PATH.exists(), "workspace.html no existe en la ruta esperada"
        )
    ...
    def test_block_is_under_empresa_not_inventario(self):
        ...
        self.assertNotEqual(
            pos_begin, -1, "No se encontró el marcador BEGIN:AF-TABLE-AND-MODAL"
        )
        self.assertNotEqual(
            pos_end, -1, "No se encontró el marcador END:AF-TABLE-AND-MODAL"
        )
        ...
        if pos_inventario != -1:
            ...
            inventario_section = norm[
                pos_inventario : pos_inventario + 5000
            ]  # Buscar en los siguientes 5000 caracteres
    ...
    def test_activos_table_included(self):
        ...
        self.assertIn(
            "_activos_table.html",
            content,
            "El include de la tabla de activos no está presente",
        )
    ...
    def test_activos_modals_included(self):
        ...
        self.assertIn(
            ...
            content,
            "El include del modal de activos no está presente",
        )
