"""
[WARNING] FASE 6: Tests críticos de Autenticación y Autorización.
...
class AuthenticationCriticalTests(TenantTestCase):
    ...
    [WARNING] FASE 6: Validaciones mínimas pero críticas del control de acceso.
    """
...
class AuthorizationCriticalTests(TenantTestCase):
    ...
    [WARNING] FASE 6: Validaciones mínimas pero críticas de permisos.
    """
