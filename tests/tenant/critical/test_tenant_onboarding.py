"""
⚠️ FASE 6: Tests críticos de Tenant Onboarding.
...
class TenantOnboardingCriticalTests(TestCase):
    ...
    ⚠️ FASE 6: Validaciones mínimas pero críticas del flujo de alta de empresa.
    """
    ...
    def test_esquema_se_crea_correctamente(self):
        ...
        with connection.cursor() as cursor:
            ...
            """, [schema_name])
            row = cursor.fetchone()
            self.assertIsNotNone(row, f"El esquema '{schema_name}' debe existir en PostgreSQL")
