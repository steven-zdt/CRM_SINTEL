"""
⚠️ FASE 6: Tests de Arranque y Disponibilidad.
...
class StartupAvailabilityTests(TestCase):
    ...
    ⚠️ FASE 6: Validaciones mínimas pero críticas de que el sistema puede iniciar.
    """
    ...
    def test_acceso_tenant_publico(self):
        ...
        with connection.cursor() as cursor:
            ...
            """, [public_schema])
            row = cursor.fetchone()
            self.assertIsNotNone(row, f"El esquema público '{public_schema}' debe existir")
