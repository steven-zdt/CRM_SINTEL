"""
[WARNING] FASE 6: Tests de Errores Críticos.
...
class CriticalErrorsTests(TestCase):
    ...
    [WARNING] FASE 6: Validaciones mínimas pero críticas de manejo de errores.
    """
    ...
    def test_acceso_dominio_inexistente(self):
        ...
        response = self.client.get("/", HTTP_HOST="dominio-inexistente.localhost")
    ...
    def test_tenant_desactivado(self):
        ...
        Domain.objects.create(
            domain="inactive.localhost", tenant=tenant, is_primary=True
        )

        # Intentar acceder
        response = self.client.get("/", HTTP_HOST="inactive.localhost")
    ...
    def test_error_esquema_no_encontrado(self):
        ...
        # Intentar acceder
        response = self.client.get("/", HTTP_HOST="esquema-inexistente.localhost")
...
class SystemResilienceTests(TestCase):
    ...
    [WARNING] FASE 6: Validaciones de que el sistema no cae ante errores esperables.
    """
