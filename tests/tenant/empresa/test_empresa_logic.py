...
from apps.services.empresa.gestion_service import (
    calcular_dv,
    crear_o_actualizar_empresa,
)
...
class TestEmpresaServiceLayer(SintelTenantTestCase):
    ...
    def test_calculo_dv(self):
        ...
        self.assertTrue(
            dv_dian.isdigit() or dv_dian == "0", "El DV debe ser un dígito (0-9)"
        )
    ...
    def test_crear_o_actualizar_empresa_calcula_dv_automaticamente(self):
        ...
        self.assertEqual(
            empresa.dv, dv_esperado, "El DV debe ser calculado correctamente"
        )
    ...
    def test_data_isolation_check(self):
        ...
        [WARNING] Este test confirma que los datos no se fugan al esquema público.
        """
        ...
        self.assertEqual(
            Empresa.objects.count(), 1, "Debe haber una empresa en el tenant actual"
        )
        ...
        # [WARNING] CRÍTICO: Empresa está en TENANT_APPS, así que la tabla NO existe en public
