...
⚠️ PATRÓN SINGLETON: Solo una empresa por tenant (garantizado por UniqueConstraint).
"""
...
class TestEmpresaSingletonDB(SintelTenantTestCase):
    ...
    def test_unique_constraint_prevents_second_empresa(self):
        ...
        self.assertIn('unique_singleton_empresa_per_schema', error_message.lower() or 'unique constraint')
    ...
    def test_serializer_validation_prevents_duplicate(self):
        ...
        self.assertIn('Ya existe una Empresa', str(serializer.errors['non_field_errors']))
...
class TestEmpresaSingletonConcurrency(TransactionTestCase):
    ...
    ⚠️ NOTA: Usa TransactionTestCase para probar transacciones concurrentes.
    """
    ...
    def test_concurrent_create_attempts(self):
        ...
        ⚠️ NOTA: Esta prueba simula concurrencia básica. En producción,
