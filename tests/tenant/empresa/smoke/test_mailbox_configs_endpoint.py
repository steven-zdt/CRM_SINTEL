...
def test_mailbox_configs_list_with_data_returns_200():
    ...
    ⚠️ MULTI-TENANT: Verifica que el endpoint funciona con datos en el esquema del tenant.
    """
...
def test_mailbox_configs_404_from_public_domain():
    ...
    ⚠️ SEGURIDAD: Las configuraciones de mailbox solo están disponibles en el ámbito del tenant.
