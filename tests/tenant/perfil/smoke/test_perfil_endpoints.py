...
def test_perfil_me_get_returns_200(client):
    ...
    domain_name = "test-perfil.sintel.com"
...
def test_perfil_me_patch_json_returns_200(client):
    ...
    # Crear dominio para el tenant
    domain_name = "test-perfil-patch.sintel.com"
    Domain.objects.get_or_create(
        domain=domain_name,
        tenant=tenant,
        defaults={"is_primary": True}
...
def test_perfil_me_patch_multipart_returns_200(client):
    ...
    # Crear dominio para el tenant
    domain_name = "test-perfil-multipart.sintel.com"
    Domain.objects.get_or_create(
        domain=domain_name,
        tenant=tenant,
        defaults={"is_primary": True}
...
def test_perfil_me_configuracion_patch_returns_200(client):
    ...
    # Crear dominio para el tenant
    domain_name = "test-perfil-config.sintel.com"
    Domain.objects.get_or_create(
        domain=domain_name,
        tenant=tenant,
        defaults={"is_primary": True}
...
def test_perfil_endpoints_404_from_public_domain(client):
    ...
    ⚠️ SEGURIDAD: Los endpoints de perfil solo están disponibles en el ámbito del tenant.
