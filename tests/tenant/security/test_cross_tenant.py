...
def test_user_cannot_access_other_tenant_domain():
    ...
    with schema_context("public"):
        ...
        domain_a = Domain.objects.create(
            tenant=tenant_a, domain="tenant-a.localhost", is_primary=True
        )
        ...
        domain_b = Domain.objects.create(
            tenant=tenant_b, domain="tenant-b.localhost", is_primary=True
        )
        ...
        TenantMembership.objects.create(client=tenant_a, user=user_a, is_active=True)
