...
⚠️ IMPORTANTE: Todas las pruebas que involucren modelos dentro de TENANT_APPS
...
class SintelTenantTestCase(TenantTestCase):
    ...
    ⚠️ IMPORTANTE: TenantTestCase maneja automáticamente:
    ...
    def setup_tenant(cls, tenant_user=None):
        ...
        ⚠️ IMPORTANTE: Este método es llamado automáticamente por TenantTestCase como método de clase.
        ...
        schema_name = f"test_{cls.__name__.lower().replace('test', '').replace('case', '')}"
    ...
    def setUp(self):
        ...
        # ⚠️ IMPORTANTE: Configurar ROOT_URLCONF para usar TENANT_URLCONF
    ...
    def setup_user(self):
        ...
        ⚠️ IMPORTANTE: Este método debe ejecutarse en el esquema public.
    ...
    def get_tenant_schema_name(self):
        ...
        class_name = self.__class__.__name__.lower().replace('test', '').replace('case', '')
