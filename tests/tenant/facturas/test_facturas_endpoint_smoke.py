...
⚠️ MULTI-TENANT: Este test verifica que el endpoint está correctamente registrado
...
class TestFacturasEndpointSmoke(SintelTenantTestCase):
    ...
    ⚠️ OBJETIVO: Verificar que el router está correctamente configurado
    ...
    def test_listado_facturas_devuelve_200(self):
        ...
        ⚠️ MULTI-TENANT: SintelTenantTestCase maneja automáticamente el tenant y el dominio.
        """
    ...
    def test_listado_facturas_vacio_devuelve_200(self):
        ...
        ⚠️ MULTI-TENANT: Verifica que el endpoint existe aunque no haya datos.
        """
    ...
    def test_listado_facturas_404_en_dominio_publico(self):
        ...
        ⚠️ SEGURIDAD: Las facturas solo están disponibles en el ámbito del tenant.
        """
