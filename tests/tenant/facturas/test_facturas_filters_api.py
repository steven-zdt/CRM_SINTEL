...
class TestFacturasFiltersAPI(SintelTenantTestCase):
    ...
    def test_filter_by_naturaleza_venta(self):
        ...
        for factura in results:
            assert (
                factura.get("naturaleza") == "VENTA"
            ), f"Expected VENTA, got {factura.get('naturaleza')}"
    ...
    def test_filter_by_naturaleza_compra(self):
        ...
        for factura in results:
            assert (
                factura.get("naturaleza") == "COMPRA"
            ), f"Expected COMPRA, got {factura.get('naturaleza')}"
    ...
    def test_filter_by_nit_emisor(self):
        ...
        for factura in results:
            ...
            assert (
                "900123456" in emisor or "900123456" in receptor
    ...
    def test_filter_by_nit_receptor(self):
        ...
        for factura in results:
            ...
            receptor = factura.get("receptor_nit", "")
            assert (
                "900999888" in emisor or "900999888" in receptor
    ...
    def test_filter_by_date_range(self):
        ...
        for factura in results:
            ...
            if fecha_str:
                ...
                assert "2024" in fecha_str or fecha_str.startswith(
                    "2024"
