"""
Tests E2E forenses con Playwright para el workspace de Facturas.
...
- Logs forenses en consola del navegador
...
@pytest.mark.e2e
def test_workspace_upload_detail_delete(page, live_server):
    """
    E2E: Flujo completo upload → detail → delete desde el workspace.
    """
...
@pytest.mark.e2e
def test_workspace_upload_missing_file_shows_error(page, live_server):
    """
