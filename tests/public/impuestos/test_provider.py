...
[WARNING] POLÍTICA SSoT: Verifica que el provider funciona correctamente
...
class ImpuestosProviderTestCase(TestCase):
    ...
    def test_get_perfil_tributario(self):
        ...
        self.assertEqual(
            perfil["tipo_contribuyente"]["clase"], ContribuyenteTipo.CLASE_PJ
        )
    ...
    def test_cache_invalidation(self):
        ...
        self.assertEqual(
            regimen3["nombre"], "Régimen Ordinario Modificado"
        )  # Valor actualizado
