...
class TestClientCRUD:
    ...
    def test_create_client_success(self):
        ...
        client = Client.objects.create(nombre="Empresa Test", schema_name="empresatest")
    ...
    def test_create_client_schema_name_validation(self):
        ...
        # Schema_name válido
        client = Client.objects.create(nombre="Test", schema_name="test-123_empresa")
        assert client.schema_name == "test-123_empresa"

        # Schema_name con mayúsculas debe ser normalizado
        client2 = Client.objects.create(nombre="Test2", schema_name="TEST-EMPRESA")
    ...
    def test_read_client(self):
        ...
        client = Client.objects.create(nombre="Empresa Lectura", schema_name="lectura")
    ...
    def test_update_client(self):
        ...
        client = Client.objects.create(
            nombre="Empresa Original", schema_name="original"
        )
    ...
    def test_delete_client_cascade(self):
        ...
        client = Client.objects.create(nombre="Empresa Delete", schema_name="delete")

        # Crear Domain (automático por señal o manual)
        domain = Domain.objects.filter(tenant=client).first()
        if not domain:
            domain = Domain.objects.create(
                domain="delete.localhost", tenant=client, is_primary=True
            )

        # Crear TenantMembership
        user = User.objects.create_user(email="user@delete.com", password="test123")
        membership = TenantMembership.objects.create(
            client=client, user=user, rol="ADMIN"
        )
    ...
    def test_client_auto_create_schema(self):
        ...
        client = Client.objects.create(
            nombre="Empresa Schema", schema_name="empresaschema"
        )
...
class TestDomainCRUD:
    ...
    def test_domain_created_by_signal(self):
        ...
        client = Client.objects.create(
            nombre="Empresa Signal", schema_name="signaltest"
        )
    ...
    def test_domain_fqdn_schema_name(self):
        ...
        client = Client.objects.create(
            nombre="Empresa FQDN", schema_name="empresa.example.com"
        )
    ...
    def test_domain_tenant_relationship(self):
        ...
        client = Client.objects.create(
            nombre="Empresa Relacion", schema_name="relacion"
        )
    ...
    def test_domain_unique(self):
        ...
        with pytest.raises(IntegrityError):
            Domain.objects.create(
                domain=domain1.domain, tenant=client2, is_primary=True
            )

    def test_domain_cascade_delete(self):
        """Test: Eliminación de Client elimina Domain en cascada."""
        client = Client.objects.create(nombre="Empresa Cascade", schema_name="cascade")
    ...
    def test_domain_multiple_per_tenant(self):
        ...
        client = Client.objects.create(nombre="Empresa Multi", schema_name="multi")
        ...
        secondary = Domain.objects.create(
            domain="multi-alternativo.localhost", tenant=client, is_primary=False
        )
...
class TestTenantMembershipCRUD:
    ...
    def test_create_membership(self):
        ...
        client = Client.objects.create(
            nombre="Empresa Membership", schema_name="membership"
        )

        user = User.objects.create_user(email="member@test.com", password="test123")

        membership = TenantMembership.objects.create(
            client=client, user=user, rol="ADMIN", is_primary_admin=True
        )
    ...
    def test_membership_unique_together(self):
        ...
        TenantMembership.objects.create(client=client, user=user, rol="ADMIN")

        # Intentar crear segunda membresía (debe fallar)
        with pytest.raises(IntegrityError):
            TenantMembership.objects.create(client=client, user=user, rol="STAFF")
    ...
    def test_membership_user_multiple_tenants(self):
        ...
        membership1 = TenantMembership.objects.create(
            client=client1, user=user, rol="ADMIN"
        )

        membership2 = TenantMembership.objects.create(
            client=client2, user=user, rol="STAFF"
        )
...
class TestFullIntegrationCRUD:
    ...
    def test_create_tenant_full_flow(self):
        ...
        # 1. Crear Client
        client = Client.objects.create(
            nombre="Empresa Completa", schema_name="completa"
        )
        ...
        user = User.objects.create_user(email="admin@completa.com", password="test123")
    ...
    def test_read_tenant_with_relationships(self):
        ...
        client = Client.objects.create(nombre="Empresa Read", schema_name="read")
    ...
    def test_update_tenant_and_verify_persistence(self):
        ...
        client = Client.objects.create(nombre="Empresa Update", schema_name="update")
...
class TestDomainIntegrity:
    ...
    def test_domain_auto_creation_from_schema_name(self):
        ...
        client1 = Client.objects.create(nombre="Empresa Simple", schema_name="simple")
        domain1 = Domain.objects.filter(tenant=client1, is_primary=True).first()
        assert domain1.domain == "simple.localhost"

        # Caso 2: Schema_name con FQDN
        client2 = Client.objects.create(
            nombre="Empresa FQDN", schema_name="fqdn.example.com"
        )
    ...
    def test_domain_uses_tenant_fk(self):
        ...
        client = Client.objects.create(nombre="Empresa FK", schema_name="fk")
