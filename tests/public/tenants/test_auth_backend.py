...
class TestTenantAwareBackend(TestCase):
    ...
    def setUp(self):
        ...
        self.domain_a = Domain.objects.create(
            domain="tenant-a.sintel.local", tenant=self.tenant_a, is_primary=True
        )

        # Crear membresía: user_con_membresia tiene membresía en tenant_a
        self.membership = TenantMembership.objects.create(
            client=self.tenant_a, user=self.user_con_membresia, rol="ADMIN"
        )
    ...
    def test_caso_a_usuario_con_membresia_autentica(self):
        ...
        self.assertIsNotNone(
            user,
            "[ERROR] VIOLACIÓN DE SEGURIDAD: El usuario con membresía debe poder autenticarse.",
        )
        self.assertEqual(
            user.id,
            self.user_con_membresia.id,
            "[ERROR] VIOLACIÓN DE SEGURIDAD: El usuario autenticado debe ser el correcto.",
        )
    ...
    def test_caso_b_usuario_sin_membresia_retorna_none(self):
        ...
        self.assertIsNone(
            user,
            "[ERROR] VIOLACIÓN DE SEGURIDAD: El usuario sin membresía NO debe poder autenticarse, "
    ...
    def test_caso_c_usuario_en_public_tenant_autentica(self):
        ...
        self.assertIsNotNone(
            user,
            "[ERROR] VIOLACIÓN: El usuario debe poder autenticarse en el tenant 'public' sin membresía.",
        )
        self.assertEqual(
            user.id,
    ...
    def test_caso_d_request_sin_tenant_autentica_fallback(self):
        ...
        self.assertIsNotNone(
            user,
            "[ERROR] VIOLACIÓN: El usuario debe poder autenticarse cuando no hay contexto de tenant "
            "(comandos de consola).",
        )
    ...
    def test_caso_e_credenciales_invalidas_retorna_none(self):
        ...
        self.assertIsNone(
            user,
            "[ERROR] VIOLACIÓN: El backend debe retornar None cuando las credenciales son inválidas.",
        )
    ...
    def test_caso_f_usuario_cross_tenant_denegado(self):
        ...
        membership_b = TenantMembership.objects.create(
            client=self.tenant_b, user=self.user_con_membresia, rol="ADMIN"
        )
        ...
        self.assertIsNone(
            user,
            "[ERROR] VIOLACIÓN DE SEGURIDAD: El usuario sin membresía en el tenant actual "
    ...
    def test_get_user(self):
        ...
        self.assertIsNotNone(
            user, "[ERROR] VIOLACIÓN: get_user debe retornar el usuario."
        )
        self.assertEqual(
            user.id,
            self.user_con_membresia.id,
            "[ERROR] VIOLACIÓN: get_user debe retornar el usuario correcto.",
        )
        ...
        self.assertIsNone(
            user_invalido,
            "[ERROR] VIOLACIÓN: get_user debe retornar None para ID inválido.",
        )
