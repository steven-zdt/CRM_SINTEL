...
from tests.public.tenants.factories import ClientFactory, DomainFactory, TenantMembershipFactory, UserFactory
...
class TestSignalException:
    ...
    def test_signal_creates_domain_automatically(self):
        ...
        assert domain.domain in ["testcorp.localhost", "testcorp"]  # Depende de TENANT_DOMAIN_BASE
    ...
    @override_settings(TENANT_DOMAIN_BASE="sintel.com")
    def test_signal_creates_domain_with_subdomain(self):
        ...
        assert domain is not None
        assert domain.domain == "testcorp.sintel.com"
