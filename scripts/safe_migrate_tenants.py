...
def main():
    ...
    if tenants_mode == 'all':
        ...
        try:
            ...
            print("[OK] Migraciones de tenant aplicadas")
            return 0
        except CommandError as e:
            print(f"[ERROR] Error al aplicar migraciones de tenant: {e}")
            return 1
        ...
        try:
            ...
            print(f"[OK] Migraciones de tenant aplicadas para schema: {schema_name}")
            return 0
        except CommandError as e:
            print(f"[ERROR] Error al aplicar migraciones de tenant para schema {schema_name}: {e}")
            return 1
        except Exception as e:
            print(f"[ERROR] Error inesperado: {e}")
            return 1
