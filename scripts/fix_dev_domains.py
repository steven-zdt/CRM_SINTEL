...
def fix_dev_domains():
    ...
    for tenant in tenants:
        ...
        for domain in domains:
            ...
            try:
                ...
                print(f"   [OK] Dominio corregido: {domain.domain} -> {domain_with_port}")
                corrected_count += 1
            except Exception as e:
                print_error(f"   [ERROR] Error al crear dominio '{domain_with_port}': {e}")
                error_count += 1
    ...
    # Resumen
    print("=" * 80)
    print("[CHART] RESUMEN DE REPARACIÓN")
    print("=" * 80)
    print(f"[OK] Dominios corregidos: {corrected_count}")
