...
def main():
    print("=" * 60)
    print("✅ VERIFICACIÓN: sintel.com COMO DOMINIO PRINCIPAL")
    print("=" * 60)
    
    # 1. Verificar TENANT_DOMAIN_BASE
    print(f"\n1. TENANT_DOMAIN_BASE: {settings.TENANT_DOMAIN_BASE}")
    if settings.TENANT_DOMAIN_BASE == 'sintel.com':
        print("   ✅ Configurado como sintel.com")
    else:
        print(f"   ⚠️  Configurado como {settings.TENANT_DOMAIN_BASE} (debería ser sintel.com)")
    ...
    with schema_context('public'):
        ...
        if primary.domain == 'sintel.com' and primary.is_primary:
            print("   ✅ sintel.com es el dominio principal")
        else:
            print("   ❌ sintel.com NO es el dominio principal")
            return 1
    ...
    print(f"   - sintel.com: {'✅' if has_sintel else '❌'}")
    print(f"   - .sintel.com: {'✅' if has_wildcard else '❌'}")
    
    # 4. Verificar ROOT_URLCONF
    print(f"\n4. ROOT_URLCONF: {settings.ROOT_URLCONF}")
    if settings.ROOT_URLCONF == 'config.urls_public':
        print("   ✅ Configurado para dominio público")
    ...
    if all_ok:
        print("✅ sintel.com ESTABLECIDO COMO DOMINIO PRINCIPAL Y DEFINITIVO")
        print("\n💡 Acceso:")
        ...
        print("❌ Configuración incompleta. Revisa los puntos arriba.")
        return 1
