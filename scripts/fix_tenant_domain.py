...
def fix_tenant_domain(hostname):
    ...
    with schema_context(get_public_schema_name()):
        ...
        if domain:
            print(f"✅ Dominio encontrado en BD:")
        ...
        print(f"❌ Dominio NO encontrado en BD")
        ...
        if not tenant:
            print(f"❌ ERROR: No existe un tenant con schema_name='{schema_name}'")
            print()
            print("💡 SOLUCIÓN:")
        ...
        if created:
            print(f"✅ Dominio creado exitosamente:")
            print(f"   - Domain: {domain.domain}")
            ...
            print(f"ℹ️  El dominio ya existía (pero no se encontró en la búsqueda inicial)")
