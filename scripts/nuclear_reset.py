...
[WARNING] ADVERTENCIA: Este script elimina:
...
def main():
    ...
    print(f"{Colors.BOLD}{Colors.HEADER}[LAUNCH] NUCLEAR RESET - SINTEL Multi-tenant SaaS{Colors.ENDC}")
    ...
    try:
        ...
        print(f"{Colors.BOLD}{Colors.OKGREEN}[OK] NUCLEAR RESET COMPLETADO EXITOSAMENTE{Colors.ENDC}")
