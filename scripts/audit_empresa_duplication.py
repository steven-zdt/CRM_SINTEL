...
⚠️ POLÍTICA SSoT: apps/tenant/empresa/api es la ÚNICA fuente de verdad.
...
def run_audit():
    ...
    sys.stdout.buffer.write(b"🔍 Auditoría: Detección de duplicación de datos empresariales...\n")
