...
⚠️ USO: Solo en desarrollo. En producción, usa migrate_schemas manualmente con control.
...
def migrate_all_schemas():
    ...
    try:
        ...
        print("✓ Migraciones de SHARED_APPS aplicadas en 'public'")
    ...
    try:
        ...
        print("✓ Migraciones de TENANT_APPS aplicadas en todos los tenants")
    except Exception as e:
