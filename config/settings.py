...
MIDDLEWARE = [
    ...
    'apps.tenant.core.middleware.SintelExceptionMiddleware',  # ✅ v2.40: Manejo centralizado de excepciones (DESPUÉS de TenantMainMiddleware para tener contexto del esquema)
...
# ⚠️ v2.36: Feature flag adicional para endpoint universal de documentos
...
LOGGING = {
    ...
    "loggers": {
        ...
        # ⚠️ WeasyPrint eliminado - Configuración de logs removida
